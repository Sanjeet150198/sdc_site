                        ...
                        <table class="display nowrap" id="example">
                            ...
                            foreach($result as $row){?>
                                <tr>
                                    ...
                                    <td><a href="edit_project.php">Edit</a> | <a href="delete_project.php">Delete</a> | <a href="change_status.php?status=1&id=<?php echo base64_encode($row->id)?>">Completed</a></td>
                                </tr>
                             <?php }}else{?>
                                 <tr>
